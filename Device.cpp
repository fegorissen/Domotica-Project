...
// plek in het hele programma waar deze teller bestaat -- gedeeld
// door alle Device-objecten, in plaats van elk object zijn eigen
// kopie te geven (wat bij een gewone member variable wel zou
// gebeuren).
